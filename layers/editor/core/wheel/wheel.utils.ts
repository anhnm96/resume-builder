...
export function isWheelAllowed(contextInstance: ReactZoomPanPinchContext, event: WheelEvent): boolean {
...
export function handleCalculateWheelZoom(contextInstance: ReactZoomPanPinchContext, delta: number, step: number, disable: boolean, getTarget?: boolean): number {
...
export function handleWheelZoomStop(contextInstance: ReactZoomPanPinchContext, event: WheelEvent): boolean {

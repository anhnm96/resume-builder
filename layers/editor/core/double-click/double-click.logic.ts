import type { LibrarySetup, ReactZoomPanPinchContext } from '../../types'
import {
  cancelTimeout,
  getContext,
  handleCallback,
...
export function handleDoubleClickStop(contextInstance: ReactZoomPanPinchContext, event: MouseEvent | TouchEvent): void {
...
export function handleDoubleClickResetMode(contextInstance: ReactZoomPanPinchContext, event: MouseEvent | TouchEvent) {
...
export function isDoubleClickAllowed(contextInstance: ReactZoomPanPinchContext, event: MouseEvent | TouchEvent): boolean {

...
export function isPanningStartAllowed(contextInstance: ReactZoomPanPinchContext, event: MouseEvent | TouchEvent): boolean {
...
export function isPanningAllowed(contextInstance: ReactZoomPanPinchContext): boolean {
...
export function handlePanningSetup(contextInstance: ReactZoomPanPinchContext, event: MouseEvent): void {
...
export function handleTouchPanningSetup(contextInstance: ReactZoomPanPinchContext, event: TouchEvent): void {
  const { touches } = event
  const { positionX, positionY } = contextInstance.transformState
...
export function getPanningClientPosition(contextInstance: ReactZoomPanPinchContext, clientX: number, clientY: number): PositionType {
...
export function getPaddingValue(contextInstance: ReactZoomPanPinchContext, size: number): number {

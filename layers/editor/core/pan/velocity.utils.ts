import type { ReactZoomPanPinchContext } from '../../types/context.model'
import { boundLimiter } from '../bounds/bounds.utils'

export function isVelocityCalculationAllowed(contextInstance: ReactZoomPanPinchContext): boolean {
...
export function isVelocityAllowed(contextInstance: ReactZoomPanPinchContext): boolean {

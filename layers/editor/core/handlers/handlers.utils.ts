import type { ReactZoomPanPinchContext, ReactZoomPanPinchState } from '../../types'
...
export function handleCalculateButtonZoom(contextInstance: ReactZoomPanPinchContext, delta: number, step: number): number {

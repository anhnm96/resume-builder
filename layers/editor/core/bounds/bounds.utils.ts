...
import type { ComponentsSizesType } from './bounds.types'
...
export function getBounds(wrapperWidth: number, newContentWidth: number, diffWidth: number, wrapperHeight: number, newContentHeight: number, diffHeight: number, centerZoomedOut: boolean): BoundsType {
...
export function calculateBounds(contextInstance: ReactZoomPanPinchContext, newScale: number): BoundsType {
 ...
 */
export function boundLimiter(value: number, minBound: number, maxBound: number, isActive: boolean): number {
...
export function handleCalculateBounds(contextInstance: ReactZoomPanPinchContext, newScale: number): BoundsType {

import type { animations } from '../core/animations/animations.constants'
import type { centerView, resetTransform, setTransform, zoomIn, zoomOut, zoomToElement } from '../core/handlers/handlers.logic'
import type { ZoomPanPinch } from '../core/instance.core'
import type { DeepNonNullable } from './helpers.model'

export type ReactZoomPanPinchContext = typeof ZoomPanPinch.prototype

export interface ReactZoomPanPinchContextState {
...
export interface ReactZoomPanPinchBaseClasses {
  wrapperClass: string
  contentClass: string
}
